...
/**
 * The user model
 * The Object Representation of a user in the database
 */
class User extends Model {
  ...
  /**
   * Returns the database properties of the user in json format
   * @return {User} user - the user json properties
   */
  public toJSON(): User {
    // Get the values
    const user = {...this.get()} as User;
  ...
  /**
   * To check if the supplied password is correct
   *
   * @param {string} password The pass in password to compare
   */
